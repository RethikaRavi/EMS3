...
using WebApiPhase3Prjt.Models;

namespace WebApiPhase3Prjt.Controllers
{
    ...
    public class EmpProfilesController : ControllerBase
    {
        ...
        public EmpProfilesController(EmployeeContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<EmpProfile>> PostEmpProfile(EmpProfile empProfile)
        {
          if (_context.EmpProfiles == null)
          {
              return Problem("Entity set 'EmployeeContext.EmpProfiles'  is null.");
          }
            ...
            {
                if (EmpProfileExists(empProfile.Ecode))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetEmpProfile", new { id = empProfile.Ecode }, empProfile);
        }
        ...
        {
            return (_context.EmpProfiles?.Any(e => e.Ecode == id)).GetValueOrDefault();
        }
    }
}
